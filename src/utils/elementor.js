...
export const getElementorCssLinksData = ( postId ) => {
	return [
		...
		{
			id: 'ad-elementor-icons-fa-solid-css',
			link: `${wordPressSiteUrl}/wp-content/plugins/essential-addons-for-elementor-lite/assets/front-end/css/view/post-grid.min.css`
		}
	]
}
